          ...
          >
            ...
            <div className="flex flex-col w-full gap-4 mt-4">
              <Link href={`/events/${createdEventId?.replace("evt_", "")}`} className="w-full">
                <button type="button" className="w-full bg-accent text-black font-bold text-xl h-16 rounded-full border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all flex items-center justify-center gap-3">
          ...
          <div className="flex-1 w-full flex flex-col gap-4">
            ...
            <div className="flex justify-end gap-14 mt-6 mr-4">
              <div className="relative w-[212px] h-[58px]">
                <div className="absolute w-[212px] h-[50px] left-0 top-[6px] bg-black rounded-[32px]" />
                <button
                  type="button"
                  onClick={() => setFormData({
                    title: "",
                  ...
                  className="absolute w-[212px] h-[50px] left-[3px] top-0 bg-white border-2 border-black rounded-[32px] flex items-center justify-center hover:bg-gray-50 transition-transform active:translate-y-1 active:translate-x-px"
                >
                  <span className="font-semibold text-[15px] text-black text-center w-[131px] leading-[30px]">
                    Clear Event
                  </span>
                </button>
              </div>
              ...
              <div className="relative w-[215px] h-[58px]">
                ...
                <button
                  ...
                  className="absolute w-[212px] h-[50px] left-[3px] top-0 bg-accent border-2 border-black rounded-[32px] flex items-center justify-center gap-[10px] hover:bg-accent-hover transition-transform active:translate-y-1 active:translate-x-px disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  <span className="font-semibold text-[15px] text-black text-center leading-[30px]">
